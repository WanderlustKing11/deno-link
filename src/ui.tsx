    ...
    <html data-theme='light'>
      ...
      <div className='min-h-screen flex flex-col bg-base-100'>
        ...
        <footer className='footer footer-center p-4 bg-base-200 text-base-content'>
          <aside>
            <p>Copyright © 2024 - All rights reserved by doughorville.io</p>
          </aside>
        </footer>
      </div>
    </html>
      ...
      <div className='hero min-h-[500px] bg-base-200 rounded-box'>
        <div className='hero-content text-center'>
          <div className='max-w-md'>
            <h1 className='text-5xl font-bold'>Welcome to link.Dougs.app</h1>
            <p className='py-6'>
              link.Dougs.app is a Deno-powered URL shortening service. Create,
